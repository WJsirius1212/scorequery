...
# name :[passwd,score]
user={'wj':['1212',[130,120,145,110,90,75,100]],'why':['1015',[120,130,140,115,79,80,101]]}
detail=[]
#testdata
...
def index(username):
    ...
    return render_template('index.html',yaver=yaver,subject=subject,teacher=teacher,subjects=subjects,subject_length=subject_length,Englishname=Englishname,yourscore=yourscore,username=username)
...
def classscore(resub,username):
    ...
    return render_template('class.html',subject=resub,c_sub=c_sub,teachername=teachername,aver=aver,yscore=score,thumbnum=thumbnum,usernum=usernum)
